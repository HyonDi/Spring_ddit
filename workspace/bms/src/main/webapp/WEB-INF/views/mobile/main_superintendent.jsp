	...
	<header class="masthead" style="height: 48px;padding-top: 5px;padding-bottom: 65px;background:white;">
  	...
  	<section class="contact bg-light" id="contact" style="padding:38px 0px;">
	    ...
	    <div class="container">
	      <ul class="list-inline list-social">
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/company/mobileList" style="width:100px; height:88px; color:black;">
	        ...
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/resident/mobileList" style="width:100px; height:88px; color:black;">
	        ...
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/manager/mobileList?chk=admin" style="width:100px; height:88px; color:black;">
