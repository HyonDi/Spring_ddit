    	     ...
    	     <div class="d-flex justify-content-center h-100">
		        <div class="searchbar">
		         ...
		         <ul class="navbar-nav ml-auto">
		          <li class="nav-item">
		            <a class="nav-link js-scroll-trigger" style="font-size:14px;" href="<%=request.getContextPath()%>/suggestion/mobileRegist">
				...
				<div style="display:block;">
					<ul class="list-group" style="width:405px; margin-left:-12px;">
					  <c:forEach items="${suggestionList}" var="suggestion">
					  		<li class="list-group-item" style="padding:18.9px;"><a href="<%=request.getContextPath()%>/suggestion/mobileDetail?suggestion_code=${suggestion.suggestion_code}&chk=dt&chk2=mem" style="color:black;">${suggestion.suggestion_title}</a></li>
					  </c:forEach>
					</ul>
				</div>
