					...
					<div class="bottom-menu">
						<ol>
							<c:forEach items="${menuList5}" var="menuList">	
									<li><a href="${menuList5.menu_url }">&emsp;&emsp;&emsp;${menuList5.menu_name }</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
					...
					<div class="bottom-menu">
						<ol>
							<c:forEach items="${menuList6}" var="menuList">	
									<li><a href="${menuList6.menu_url }">&emsp;&emsp;&emsp;${menuList6.menu_name }</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
					...
					<div class="bottom-menu">
						<ol>
							<c:forEach items="${menuList7}" var="menuList">	
									<li><a href="${menuList7.menu_url }">&emsp;&emsp;&emsp;${menuList7.menu_name }</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
					...
					<div class="bottom-menu">
						<ol>
							<c:forEach items="${menuList8}" var="menuList">	
									<li><a href="${menuList8.menu_url }">&emsp;&emsp;&emsp;${menuList8.menu_name }</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
