package com.bms.request.paging;

public class FacilityPageMaker {
	...
	private FacilitySearchCriteria cri; //현재 페이지 정보
	...
	public FacilitySearchCriteria getCri() {
		return cri;
	}

	public void setCri(FacilitySearchCriteria cri) {
		this.cri = cri;
	}
