...
<body id="page-top">
	...
	<header class="masthead" style="height: 48px;padding-top: 5px;padding-bottom: 65px;background:white;">
  	...
  	<section class="contact bg-light" id="contact" style="padding:38px 0px;">
	    ...
	    <div class="container">
	      <ul class="list-inline list-social">
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/notice/mobileList?chk=mem" style="width:100px; height:88px; color:black;">
	        ...
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/community/mobileList" style="width:100px; height:88px; color:black;">
				<img src="<%=request.getContextPath()%>/resources/mobile/img/소통.png" alt="입주자소통" class="img-responsive img-rounded" style="display:inline; width:50px; height:50px;">
	            <span style="font-size:20px; font-weight:bold; display:block;">입주자소통</span>
	          </a>
	        </li>
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/suggestion/mobileList?chk=mem" style="width:100px; height:88px; color:black;">
	    ...
	    <div class="container">
	      <ul class="list-inline list-social">
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/constract/mobileList" style="width:100px; height:88px; color:black;">
	            <img src="<%=request.getContextPath()%>/resources/mobile/img/계약.png" alt="계약내역" class="img-responsive img-rounded" style="display:inline; width:50px; height:50px;">
	            <span style="font-size:20px; font-weight:bold; display:block;">계약내역</span>
	          </a>
	        </li>
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/payment/mobileList" style="width:100px; height:88px; color:black;">
				<img src="<%=request.getContextPath()%>/resources/mobile/img/납부.png" alt="납부내역" class="img-responsive img-rounded" style="display:inline; width:50px; height:50px;">
	            <span style="font-size:20px; font-weight:bold; display:block;">납부내역</span>
	          </a>
	        </li>
	        <li class="list-inline-item">
	          <a href="<%=request.getContextPath()%>/manager/mobileList?chk=mem" style="width:100px; height:88px; color:black;">
	...
	<section class="contact" id="contact2" style="padding-top:0px; padding-bottom:0px;">
		<div class="container">
			<div class="btn-group" style="height:50px">
	            ...
	            <button type="button" id="sotongMain" onclick="sotong();" class="btn btn-secondary" style="border-radius:0px; width:206px; margin-left:0px;">입주민소통</button>
          	</div>
			<div id="noticeId" style="display:block;">
				<ul class="list-group" style="width:410px; margin-left:-15px;">
				  <c:forEach items="${noticeList}" var="notice">
				  		<li class="list-group-item"><a href="<%=request.getContextPath()%>/notice/mobileDetail?notice_code=${notice.notice_code}&chk=dt&chk2=mem" style="color:black;">${notice.notice_title}</a></li>
				  </c:forEach>
				</ul>
			</div>
			<div id="sotongId" style="display:none;">
				<ul class="list-group" style="width:410px; margin-left:-15px;">
				  <c:forEach items="${communityList}" var="community">
				  		<li class="list-group-item"><a href="<%=request.getContextPath()%>/community/mobileDetail?community_code=${community.community_code}&chk=dt&chk2=mem"  style="color:black;">${community.community_title}</a></li>
				  </c:forEach>
				</ul>
			</div>
		</div>
  ...
  <script>
  	...
  	function notices(){
  		...
  		$("div[id='sotongId']").css('display', 'none');
  		
  		$("button[id='noticeMain']").attr('class','btn btn-primary');
  		$("button[id='sotongMain']").attr('class','btn btn-secondary');
  	}
  
  	function sotong(){
  		$("div[id='noticeId']").css('display', 'none');
  		$("div[id='sotongId']").css('display', 'block');
  		
  		$("button[id='noticeMain']").attr('class','btn btn-secondary');
  		$("button[id='sotongMain']").attr('class','btn btn-primary');
  	}
