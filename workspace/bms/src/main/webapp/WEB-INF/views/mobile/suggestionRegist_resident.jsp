...
<head>
	...
	<body id="page-top">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	    <div class="container">
	    	...
	    	<span style="font-weight: bold; font-size:20px;">건의사항 등록</span>
	    </div>
	  </nav>
  ...
  <script>
  		...
  		function goRegist(){
  			...
  			if(suggestion_title.length == 0 || suggestion_contents.length == 0){
  				modal({
  	  	  			type: 'alert',
  	  	  			title : '해당 항목 확인',
  			...
  			$.ajax({
  				url : '<%=request.getContextPath()%>/suggestion/mobileRegistAdd',
  				data : {
