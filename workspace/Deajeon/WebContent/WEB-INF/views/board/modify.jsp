		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-outline card-primary">
					...
					<div class="card-body">
						<form enctype="multipart/form-data" role="form" method="post" action="modify.do?bno=${board.bno }" name="modifyForm">
										...
										<ul class="mailbox-attachments d-flex align-items-stretch clearfix">
											...
											<li class="attach-item">																			
												<div class="mailbox-attachment-info">
													<a class="mailbox-attachment-name" attach-fileName="${attach.fileName }" attach-no="${attach.ano }" href="<%=request.getContextPath()%>/attach/getFile.do?bno=${board.bno }&ano=${attach.ano }" name="attachedFile" >													
