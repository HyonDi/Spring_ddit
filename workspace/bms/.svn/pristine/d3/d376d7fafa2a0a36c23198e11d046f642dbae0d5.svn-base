...
public class ScheduleDaoImpl implements ScheduleDao {
	...
	public List<ScheduleVO> SuperintendentSchedule() throws SQLException {
		...
		scheduleList = session.selectList("Schedule-Mapper.SuperintendentSchedule");
		return scheduleList;
	}
	...
	public ScheduleSortCodeVO selectOneScheduleSortCode(String schedule_sort_code) throws SQLException {
		...
		scheduleSortCodeVO = session.selectOne("Schedule-Mapper.selectOneSchedule", schedule_sort_code);
