  ...
  <link href="<%=request.getContextPath()%>/resources/mobile/css/new-age.min.css" rel="stylesheet">
	...
	<body id="page-top" style="height: 700px;width: 405px;">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	    <div class="container">
	    	<a class="navbar-brand js-scroll-trigger" style="color:black; display:inline;" href="javascript:location.href='<%=request.getContextPath()%>/mobile/main_resident';"><ion-icon name="arrow-round-back" style="font-size: 30px; padding-right:20px" /></a>
	    	<span style="font-weight: bold; font-size:20px;">관리인 목록</span>
				...
				<div style="display:block;">
					...
					<table border="0" style="font-size:9pt; width:100%;" cellspacing=0 cellpadding=0>
						<tr>
							...
							<img id='userphoto'  src="<%=request.getContextPath() %>/manager/picture/${manager.member_code}" BORDER=0 width="80" height="100" 
							onerror="this.src='<%=request.getContextPath() %>/resources/images/photo_user_default.png';">
							</td>
							<td valign="center">
								<table id=Info width=99% border=0 cellpadding=0 cellspacing=0>
									...
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;관리인 : ${manager.member_name}</td>
									</tr>
								
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;담담업무 : ${manager.superintendent_significant}</td>
									</tr>
									
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<c:set var="phone" value="${manager.member_phone}" />
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;휴대폰 : <a style="color:black;" href="tel:${phone}">${fn:substring(phone, 0, 3)} - ${fn:substring(phone, 3, 7)} - ${fn:substring(phone, 7, 11)}</a></td>
									</tr>
									
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;이메일 : <a style="color:black;" href="mailto:${manager.member_email }">${manager.member_email }</a></td>
									</tr>
  ...
  <script>
	function searchList_go(page,url){
		...
		if(url){
			...
			jobForm.attr("action","mobileList?chk=mem");
		}
