...
public class CommunityReplyRequest {
	...
	public String getReply_up_code() {
		return reply_up_code;
	}
	public void setReply_up_code(String reply_up_code) {
		this.reply_up_code = reply_up_code;
	}
	...
	public String toString() {
		return "CommunityReplyRequest [reply_code=" + reply_code + ", member_code=" + member_code + ", reply_contents="
				+ reply_contents + ", reply_reg_date=" + reply_reg_date + ", board_code=" + board_code
				+ ", reply_up_code=" + reply_up_code + ", board_sort_code=" + board_sort_code + ", member_name="
				+ member_name + "]";
	}
