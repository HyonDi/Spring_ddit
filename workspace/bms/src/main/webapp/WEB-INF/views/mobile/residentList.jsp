	...
	<body id="page-top" style="height: 700px;width: 405px;">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	    <div class="container">
	    	...
	    	<span style="font-weight: bold; font-size:20px;">입주자 목록</span>
				...
				<div style="display:block;">
					...
					<table border="0" style="font-size:9pt; width:100%;" cellspacing=0 cellpadding=0>
						<tr>
							...
							<img id='userphoto'  src="<%=request.getContextPath() %>/resident/picture/${resident.member_code}" BORDER=0 width="80" height="100" 
							...
							<td valign="center" style="width:100%">
								<table id=Info width=99% border=0 cellpadding=0 cellspacing=0>
									...
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;입주자 : ${resident.member_name}</td>
									</tr>
								
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;입주지 : ${resident.member_address}</td>
									</tr>
								
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;입주일 : <fmt:formatDate value="${resident.member_regdate }" pattern="yyyy-MM-dd" /></td>
									</tr>
									
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<c:set var="phone" value="${resident.member_phone}" />
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;휴대폰 : <a style="color:black;" href="tel:${resident.member_phone}">${fn:substring(phone, 0, 3)} - ${fn:substring(phone, 3, 7)} - ${fn:substring(phone, 7, 11)}</a></td>
									</tr>
									
									<tr><td background="<%=request.getContextPath()%>/resources/images/etc_infor_vline.gif" height=1></td></tr>
									<tr height=22>
										<td>&nbsp;<img src="<%=request.getContextPath()%>/resources/images/etc_infor_dot.gif" border=0>&nbsp;이메일 : <a style="color:black;" href="mailto:${resident.member_email }">${resident.member_email }</a></td>
									</tr>
