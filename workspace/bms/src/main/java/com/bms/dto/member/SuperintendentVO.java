...
public class SuperintendentVO {
	...
	private int superintendent_pay;
	private String superintendent_significant;
	private String member_picture;
	
	public SuperintendentVO() {}
	
	public SuperintendentVO(String member_code, String member_id, String member_pwd, String member_name,
			String member_ssn, String member_address, String member_email, String member_phone,
			Date member_recent_login_time, String member_sort_code, String member_up_code, String member_authority,
			int member_pwdupdatechk, int superintendent_pay, String superintendent_significant, String member_picture) {
		super();
	...
	public int getSuperintendent_pay() {
		return superintendent_pay;
	}
	public void setSuperintendent_pay(int superintendent_pay) {
		this.superintendent_pay = superintendent_pay;
	}
	...
	public String toString() {
		return "SuperIntendentVO [member_code=" + member_code + ", member_id=" + member_id + ", member_pwd="
				+ member_pwd + ", member_name=" + member_name + ", member_ssn=" + member_ssn + ", member_address="
				+ member_address + ", member_email=" + member_email + ", member_phone=" + member_phone
				+ ", member_recent_login_time=" + member_recent_login_time + ", member_sort_code=" + member_sort_code
				+ ", member_up_code=" + member_up_code + ", member_authority=" + member_authority
				+ ", member_pwdupdatechk=" + member_pwdupdatechk + ", superintendent_pay=" + superintendent_pay
				+ ", superintendent_significant=" + superintendent_significant + "]";
	}
