...
<body>
  ...
  <form role="form" action="<%=request.getContextPath()%>/member/addSuperintendent" method="post">
      ...
      <div class="form-group  row"><label class="col-sm-2 col-form-label">비밀번호 확인</label>
          <div class="col-sm-9"><input id="pwdchkInput" required="required" type="password" class="form-control inputHelp">
      ...
      <div class="form-group  row"><label class="col-sm-2 col-form-label">특이사항</label>
          <div class="col-sm-8"><input name="superintendent_significant" id="significantInput" type="text" class="form-control inputHelp">
          </div>
      </div>
      <div class="form-group  row"><label class="col-sm-2 col-form-label">페이</label>
          <div class="col-sm-8"><input name="superintendent_pay" id="payInput" type="text" class="form-control inputHelp">
          </div>
      </div>
      <br/><br/>
      ...
      <div id="addressstart" class="form-group  row"><label class="col-sm-2 col-form-label">주소</label>
      	<div>
            <input class="form-control address" type="text" id="postcode" placeholder="우편번호">
			<input id="addressBtn" type="button" class="btn btn-outline btn-success" onclick="DaumPostcode()" value="우편번호찾기"/>
		</div>
		<div>	
			<input class="form-control address col-sm-3" type="text" id="roadAddress" placeholder="도로명주소">
			<input class="form-control address col-sm-3" type="text" id="jibunAddress" placeholder="지번주소">
			<span class="form-control address" id="guide" style="color:#999;display:none"></span>
			<input class="form-control address col-sm-3" type="text" id="detailAddress" placeholder="상세주소">
			<!-- <input class="form-control address" type="text" id="extraAddress" placeholder="참고항목"> -->
