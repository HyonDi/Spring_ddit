				...
				<div style="display:block;">
					<ul class="list-group" style="width:405px; margin-left:-12px;">
					  <c:forEach items="${noticeList}" var="notice">
					  		<li class="list-group-item" style="padding:18.9px;"><a href="<%=request.getContextPath()%>/notice/mobileDetail?notice_code=${notice.notice_code}&chk=dc&chk2=mem" style="color:black;">${notice.notice_title}</a></li>
					  </c:forEach>
					</ul>
				</div>
