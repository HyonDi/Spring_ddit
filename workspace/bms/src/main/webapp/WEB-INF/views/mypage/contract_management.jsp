						...
						<div class="table100">
							<table>
								...
								<c:forEach items="${constractList }" var="constract">
									<c:if test="${constract.member_code eq loginUser.member_code }">
...
function searchList_go(page){
	...
	jobForm.attr("action","<%=request.getContextPath()%>/mypage/contract_management/resident/test").attr("method","post");
	jobForm.submit();
}	
</script>
