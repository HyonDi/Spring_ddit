        ...
        <div id="leftDiv" class="ibox-content profile-content">
           <h5>
            ...
            <p>
                	...
                	<label class="infor"><i class="fa fa-pencil"></i></label>${superintendent.superintendent_significant }<br/>
            ...
            <div id="btns" class="ibox-content">
                ...
                <button type="button" class="btn btn-primary btn-sm btns" onClick="location.href='<%=request.getContextPath()%>/member/modifySuperintendent?member_code=${superintendent.member_code }'">계정 수정</button>
            </div>
...
<script>
    ...
    function goRemove(){
		...
		location.href='<%=request.getContextPath()%>/member/deleteSuperintendent?member_code=${superintendent.member_code }';
