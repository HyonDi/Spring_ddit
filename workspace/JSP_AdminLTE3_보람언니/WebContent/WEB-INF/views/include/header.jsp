...
<head>
  ...
  <%-- <decorator:title></decorator:title> : 헤더 밑에 들어올 화면(jsp)에 title이 있다면 여기에 넣어라--%>
  <%-- default="은주's encodiong" : 들어올 화면에 title이 없는 경우 나올 title 설정 --%>
  <title><decorator:title default="은주's encodiong"></decorator:title></title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<%=request.getContextPath()%>/member/picture/get.do?picture=${loginUser.picture}" class="img-circle elevation-2" alt="User Image"
          				onerror="this.src='http://www.placehold.it/128x128'">
        </div>
        <div class="info">
          <div class="row">
