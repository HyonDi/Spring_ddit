			...
			<div class="container-table100">
				<div class="form-inline form-group " style="width: 90%;">
					...
					<form id="f1" method="post">
						<button type="button" class="btn btn-danger" id="registbtn" onclick="OpenWindow('<%=request.getContextPath()%>/contract_payment/registForm','등록',800,600)"> 
						등&nbsp;록 
						</button>
					</form>
						...
						<div class="table100">
							<table>
								<tr class="table100-head">
									<th class="column1" style="text-align: center;">No</th>
									<th class="column2" style="text-align: center;">입주인 이름</th>
									<th class="column3" style="text-align: center;">날짜</th>
									<th class="column4" style="text-align: center;">납부한 금액</th>
									<th class="column5" style="text-align: center;">납부 방법</th>
									<th class="column6" style="text-align: center;">납부 유형</th>
								...
								<c:forEach items="${paymentList }" var="payment">							
									<tr style="font-size: 0.85em;">
										...
										<td style="text-align: center;">${payment.payment_plan}</td>
