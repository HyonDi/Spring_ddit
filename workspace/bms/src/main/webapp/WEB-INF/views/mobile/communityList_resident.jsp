	...
	<body id="page-top" style="height: 700px;width: 405px;">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	    <div class="container">
	    	...
	    	<span style="font-weight: bold; font-size:20px;">입주자 소통</span>
    	     ...
    	     <div class="d-flex justify-content-center h-100">
		        <div class="searchbar">
		         ...
		         <ul class="navbar-nav ml-auto">
		          <li class="nav-item">
		            <a class="nav-link js-scroll-trigger" style="font-size:14px;" href="<%=request.getContextPath()%>/community/mobileRegist">
				...
				<div style="display:block;">
					<ul class="list-group" style="width:405px; margin-left:-12px;">
					  <c:forEach items="${communityList}" var="community">
					  		<li class="list-group-item" style="padding:18.9px;"><a href="<%=request.getContextPath()%>/community/mobileDetail?community_code=${community.community_code}&chk=dc" style="color:black;">${community.community_title}</a></li>
					  </c:forEach>
					</ul>
				</div>
