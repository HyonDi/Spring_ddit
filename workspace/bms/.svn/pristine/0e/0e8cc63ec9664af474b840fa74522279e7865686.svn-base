	...
	<div class="ibox-content">
		<div class="form-group" id="data_5">
			...
			<div class="input-daterange input-group" id="datepicker">
			        <input type="text" class="form-control-sm form-control" name="schedule_start_date" value="05/14/2014">
			        <span class="input-group-addon"> &emsp;~&emsp; </span>
			        <input type="text" class="form-control-sm form-control" name="schedule_end_date" value="05/22/2014">
		    </div>
		</div>
		...
		<div class="clockPick">
		    ...
		    <div class="form-group input-daterange input-group">
			          ...
			          <input type='checkbox' id='isAllDay' value="isAllDay" class="i-checks icheckbox_square-grey makeCheck" />
		...
		<div class="contents input-group">
			<div class="form-control noneborder">
				<h3>내용</h3>
				<input name="schedule_name" class="form-control" type="text"/>
			</div>
			<div>&emsp;&emsp;</div>
			<div class="form-control noneborder">
				<h3>상세 설명</h3>
				<input name="schedule_contents" class="form-control" type="text"/>
			</div>
		</div>
		...
		<br/>
			<button type="submit" class="btn btn-outline btn-success" onclick="goSubmit('post','');">등&emsp;록</button>
