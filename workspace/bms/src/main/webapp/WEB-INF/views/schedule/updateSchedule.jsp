	...
	<div class="ibox-content">
		<div class="form-group" id="data_5">
			...
			<div class="input-daterange input-group" id="datepicker">
			        <input id="startDate" type="text" class="form-control-sm form-control" name="schedule_start_date" value="${oneSchedule.schedule_start_date} ">
			        <span class="input-group-addon"> &emsp;~&emsp; </span>
			        <input id="endDate" type="text" class="form-control-sm form-control" name="schedule_end_date" value="${oneSchedule.schedule_end_date}"><!-- value="05/22/2014" -->
		    </div>
		</div>
		...
		<div class="clockPick">
		    ...
		    <div class="form-group input-daterange input-group">
			          ...
			          <input id="startTime" class="form-control clock clockpicker2" name="schedule_start_time" type="text" placeholder="시작 시간">
			          <span class="input-group input-group-addon clock "> &emsp;~&emsp; </span>
			          <input id="endTime" class="form-control clock clockpicker2" name="schedule_end_time" type="text" placeholder="종료 시간">
			        
			          <input type='checkbox' id='isAllDay' value="isAllDay" class="i-checks icheckbox_square-grey makeCheck" <c:if test="${oneSchedule.schedule_isallday==1}">checked="checked"</c:if> />
		...
		<div class="contents input-group">
			<div class="form-control noneborder">
				<h3>내용</h3>
				<input name="schedule_name" class="form-control" type="text" value="${oneSchedule.schedule_name}"/>
			</div>
			<div>&emsp;&emsp;</div>
			<div class="form-control noneborder">
				<h3>상세 설명</h3>
				<input name="schedule_contents" class="form-control" type="text" value="${oneSchedule.schedule_contents}"/>
			</div>
		</div>
		...
		<div class="sortCode">
			...
			<div class="form-group input-daterange input-group">
	            ...
	            <select name="schedule_sort_code" class="form-control" id="sortCode">
		...
		<br/>
			<button type="submit" class="btn btn-outline btn-success" onclick="goSubmit('post','');">저&emsp;장</button>
