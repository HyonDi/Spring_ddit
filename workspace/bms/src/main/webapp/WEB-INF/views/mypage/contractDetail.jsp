    ...
    <div class="row">
        ...
        <div id="no-more-tables">
            <table class="table-bordered table-striped table-condensed table-center"
				...
				<tbody>
        			<tr>        			
        				<td style="font-size: 20px; width: 160px;">입주자 번호</td>
        				<td>${constract.member_code }</td> 
        			</tr>
        			<tr>	      			
        				<td style="font-size: 20px;">계약 시작 날싸</td>
        				<td><fmt:formatDate
							value="${constract.constract_start_date }"
							pattern="yyyy-MM-dd" /></td>
        			</tr>
        			<tr>	      			
        				<td style="font-size: 20px;">계약 만기 날짜</td>
        				<td><fmt:formatDate
							value="${constract.constract_last_date }"
							pattern="yyyy-MM-dd" /></td>
        			</tr>
        			<tr>	      			
        				<td style="font-size: 20px;">계약 유형</td>
        				<td>${constract.constract_kind }</td>
        			</tr>
        			<tr>	      			
        				<td style="font-size: 20px;">계약 금액</td>
        				<td>${constract.constract_amount }</td>
        			</tr>
        			<tr>	      			
        				<td style="font-size: 20px;">계약 기간</td>
        				<td>${constract.constract_term }</td>
        			</tr>
        			<tr>	      			
        				<td style="font-size: 20px;">계약 구분</td>
