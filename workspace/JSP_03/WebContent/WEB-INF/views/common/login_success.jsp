...
<body class="sidebar-mini pace-primary pace-done sidebar-collapse" style="height: auto;"><div class="pace pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
  ...
  <div class="content-wrapper" style="min-height: 1589.56px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>${loginUser.id}님  </b> 어서오세요.</h1>
          </div>
          <div class="col-sm-6">
