	...
	<div class="page-content" style="padding-bottoms:8px;">
		...
		<div class="row">
			<div class="wizard-actions">
				...
				<button type="button" class="btn btn-sm btn-white btn-bold" onclick="<%-- javascript:closeDoc(); --%>history.go(-1);">
					<i class="grey ace-icon fa fa-times bigger-120"></i><b><%-- 닫기 --%>취소</b>
				</button>
			</div>
		</div>
		<!-- 상단 우측버튼 -->
