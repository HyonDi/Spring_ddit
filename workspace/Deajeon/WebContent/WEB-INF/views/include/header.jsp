...
<head>
  ...
  <title><decorator:title default="대전광역시청"/></title>
...
<div class="wrapper">
  ...
  <nav class="navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        ...
        <img src="<%=request.getContextPath()%>/resources/images/대전광역시.png" alt="Logo">
        </a> --%>
      </li>
    
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="#"><i class="fas fa-bars" style="color:#FFFCFA"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<%=request.getContextPath() %>/member/list.do" class="nav-link" style="color:#FFFCFA">회원관리</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<%=request.getContextPath() %>/board/list.do" class="nav-link" style="color:#FFFCFA">자유게시판</a>
      </li>
       <%-- <li class="nav-item d-none d-sm-inline-block">
        <a href="<%=request.getContextPath() %>/pds/list.do" class="nav-link" style="color:#FFFCFA">자료실</a>
      </li> --%>
    </ul>
