...
public class FacilityManageVO {
	...
	public String toString() {
		return "FacilityManageVO [facility_code=" + facility_code + ", member_code=" + member_code + ", facility_name="
				+ facility_name + ", facility_url=" + facility_url + ", facility_picture=" + facility_picture
				+ ", check_point_facility_code=" + check_point_facility_code + ", check_point_facility_contents="
				+ check_point_facility_contents + ", member_name=" + member_name + ", getFacility_code()="
				+ getFacility_code() + ", getMember_code()=" + getMember_code() + ", getFacility_name()="
				+ getFacility_name() + ", getFacility_url()=" + getFacility_url() + ", getFacility_picture()="
				+ getFacility_picture() + ", getCheck_point_facility_code()=" + getCheck_point_facility_code()
				+ ", getCheck_point_facility_contents()=" + getCheck_point_facility_contents() + ", getMember_name()="
				+ getMember_name() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
